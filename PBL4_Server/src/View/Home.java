...
//CRUD DATA+++++++++++++++++++++++++++++++++++++++
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        ...
        for(M_Nhanvien nv:nhanvien){
            ...
            TableNV.getRowCount()+1,nv.getMaNV(),nv.getTen(),nv.getChucvu(),nv.getDate(),nv.getGioitinh(),nv.getDiachi(),nv.getEmail(),nv.getLuong()
        });
        }
        }
    ...
    private void TableNVMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TableNVMouseClicked
        ...
        if(nv.getGioitinh()== "Nam"){rdNam.setSelected(true);rdNu.setSelected(false);}
