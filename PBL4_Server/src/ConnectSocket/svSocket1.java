       ...
       Thread listenThread = new Thread(() -> {
            try {
                ...
                while (true) {
                    ...
                    JOptionPane.showMessageDialog(null, "client đã kết nối có địa chỉ: "+clientAddress+" trên cổng: "+clientPort);
...
//                            nv.setDate(Date.(row.get(4).toString()));
                            ...
                            //
                            nv.setGioitinh(row.get(4).toString());
...
//                            nv.setDate(Date.(row.get(4).toString()));
    ...
    public static void main(String[] args) {
        ...
        svSocket1 server  =  new svSocket1();
